...
const PROBES: &[(&str, Method)] = &[
    ...
    ("/api/dispatch-policy", Method::Get),
    ("/api/repos/p/dispatch-policy", Method::Get),
    ("/api/repos/p/story/SH-1/dispatch-policy/codex", Method::Get),
    ...
    ("/api/repos/p/verification/control", Method::Post),
    ("/api/repos/p/engine", Method::Get),
    ("/api/repos/p/engine/pause", Method::Post),
    ("/api/repos/p/engine/nope", Method::Post),
    ("/api/repos/p/nope", Method::Get),
    ("/api/repos/p/story", Method::Post),
    ("/api/repos/p/story/SH-1", Method::Get),
    ("/api/repos/p/story/SH-1/attachments/1", Method::Get),
    ("/api/repos/p/story/SH-1", Method::Patch),
    ("/api/repos/p/story/SH-1", Method::Delete),
    ("/api/repos/p/story/SH-1/move", Method::Post),
    ("/api/repos/p/story/SH-1/attachments", Method::Post),
