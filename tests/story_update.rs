...
fn explicit_release_source_routes_without_a_project_checkout() {
    ...
    story(dir.path())
        ...
        .args([
            ...
            "--check",
            "--source",
            "github.example.com/acme/storyhook",
        ])
        .assert()
        .success()
    ...
    assert_eq!(
        calls.trim(),
        "github.example.com|github.example.com/acme/storyhook|release view --json tagName --repo github.example.com/acme/storyhook"
    );
}
...
fn update_downloads_smoke_tests_and_publishes_matching_source_metadata() {
    ...
    for valid in [false, true] {
        ...
        cmd.current_dir(dir.path())
            ...
            .args(["update", "--source", "github.example.com/acme/storyhook"]);
        ...
        assert_eq!(metadata["source"], "github.example.com/acme/storyhook");
        assert_eq!(
            metadata["sha256"],
