...
Run `story handoff --since <duration>` where duration defaults to `2h`. If the user provided a different duration (e.g., `/storyhook:handoff --since 4h`), use that value.
